...
const files=['packing-list.txt','index.html','app.js','gallery.mjs','core.mjs','itinerary-map.mjs','amap-map.mjs','map-config.json','style.css','favicon.svg','LICENSE','NOTICE.md','README.md','site-config.json','.nojekyll'];
validatePlan(plan);
...
console.log('Static site built in dist/. Public map configuration included; no server components.');
