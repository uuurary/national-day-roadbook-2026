...
const files=['index.html','app.js','core.mjs','itinerary-map.mjs','amap-map.mjs','map-config.json','style.css','package.json','README.md','NOTICE.md','site-config.json','data/plan.mjs','data/plan.json','data/amap-coordinates.json','assets/chengkan.jpg','assets/xiandu.jpg','scripts/build.mjs','scripts/cache-amap.cjs','scripts/serve.mjs','scripts/publish.mjs','tests/plan.test.mjs','tests/map.test.mjs','tests/current-browser.cjs','tests/day-map-browser.cjs','tests/amap-browser.cjs'];
