...
const files=['index.html','app.js','gallery.mjs','data/gallery.mjs','assets/taohuatan.jpg','assets/xidi.jpg','assets/fuchun.jpg','core.mjs','itinerary-map.mjs','amap-map.mjs','map-config.json','style.css','package.json','README.md','NOTICE.md','site-config.json','data/jingxian-update.mjs','packing-list.txt','data/plan.mjs','data/plan.json','data/amap-coordinates.json','assets/chengkan.jpg','assets/xiandu.jpg','scripts/build.mjs','scripts/cache-amap.cjs','scripts/serve.mjs','scripts/publish.mjs','tests/gallery.test.mjs','tests/gallery-browser.cjs','scripts/fetch-gallery.cjs','tests/plan.test.mjs','tests/map.test.mjs','tests/current-browser.cjs','tests/day-map-browser.cjs','tests/amap-browser.cjs'];
...
const commit=api(`repos/${repo}/git/commits`,'POST',{message:process.env.COMMIT_MESSAGE||'Update interactive 2026 National Day itinerary',tree:built.sha,parents:[expected]});
