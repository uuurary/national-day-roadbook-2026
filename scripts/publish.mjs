...
const files=['index.html','app.js','core.mjs','itinerary-map.mjs','style.css','package.json','README.md','NOTICE.md','site-config.json','data/plan.mjs','data/plan.json','assets/chengkan.jpg','assets/xiandu.jpg','scripts/build.mjs','scripts/serve.mjs','scripts/publish.mjs','tests/plan.test.mjs','tests/map.test.mjs','tests/current-browser.cjs','tests/day-map-browser.cjs'];
